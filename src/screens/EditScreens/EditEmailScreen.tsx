...
type EditEmailScreenProps = NativeStackScreenProps<RootStackParamList, 'EditEmailScreen'>;

export function EditEmailScreen({ navigation, route }: EditEmailScreenProps) {
